...
CKPT="/workspace/weights/model.ckpt"
DATAROOT="/workspace/datasets/nuscenes/v1.0"                 # v1.0-{trainval} + samples/ sweeps/ maps/
MAPDIR="/workspace/datasets/nuscenes/map-labels-v1.3/datasets/nuscenes/map-labels-v1.3/"         # PNGs por token 
